...
@onready var _customer_name_label: Label =  $ColorRect/MarginContainer/VBoxContainer/CustomerNameLabel
@onready var _flavor_label: Label = $ColorRect/MarginContainer/VBoxContainer/HBoxContainer/FlavorLabel
@onready var _offer_label: Label = $ColorRect/MarginContainer/VBoxContainer/OfferLabel
@onready var _item_icon: TextureRect = $ColorRect/MarginContainer/VBoxContainer/HBoxContainer3/ItemIcon
@onready var _item_name_label: Label = $ColorRect/MarginContainer/VBoxContainer/HBoxContainer3/ItemName
@onready var _item_value_label: Label = $ColorRect/MarginContainer/VBoxContainer/HBoxContainer3/ValueLabel
